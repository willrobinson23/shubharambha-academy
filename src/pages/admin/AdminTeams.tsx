...
const AdminTeams = () => {
  ...
  return (
    <AdminLayout>
      <h1 className="text-2xl font-display font-bold mb-6">Manage Teams</h1>

      <Card className="mb-8">
        <CardContent className="p-6">
          <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
            <Users className="h-5 w-5" /> Add New Team Member
          </h2>
          <form onSubmit={handleAdd} className="space-y-6">
            ...
            <Button type="submit" disabled={addTeamMutation.isPending || isUploading}>
              {addTeamMutation.isPending || isUploading ? "Adding..." : "Add to Team"}
            </Button>
          </form>
        </CardContent>
      </Card>
